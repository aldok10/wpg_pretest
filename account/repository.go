...
type Repository interface {
	...
	UpdateAccountByID(ctx context.Context, a Account, id string) error
...
func (r *postgresRepository) UpdateAccountByID(ctx context.Context, a Account, id string) error {
	_, err := r.db.ExecContext(ctx, "UPDATE accounts SET name = $1 WHERE id = $2", a.Name, id)
	return err
}
